...
from healing.openstack.common import context as request_context
from healing.openstack.common.db.sqlalchemy import models
from healing.openstack.common.gettextutils import _, _LI, _LW
...
def drop_unique_constraint(migrate_engine, table_name, uc_name, *columns,
    ...
    DEPRECATED: this function is deprecated and will be removed from healing.db
